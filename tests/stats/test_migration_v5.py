...
def test_fresh_schema_installs_current_with_deterministic_fingerprint(
    ...
    assert first_result.version == second_result.version == 13
    assert first_result.schema_fingerprint == FORMAL_SCHEMA_V13_FINGERPRINT
    assert second_result.schema_fingerprint == FORMAL_SCHEMA_V13_FINGERPRINT
...
def test_ensure_schema_is_idempotent_at_current(tmp_path: Path) -> None:
    ...
    assert second.schema_fingerprint == FORMAL_SCHEMA_V13_FINGERPRINT
