...
def test_v6_upgrades_through_v9_and_empty_database_installs_current_schema(
    ...
    assert upgraded.version == 13
    assert upgraded.schema_fingerprint == FORMAL_SCHEMA_V13_FINGERPRINT
    ...
    assert empty.schema_info()["fingerprint"] == FORMAL_SCHEMA_V13_FINGERPRINT
